...
import MyGroupGalleryCard from "../widgets/MyGroupGalleryCard";
import { Stack, Box } from "@mui/material";
import { UserGroups } from '../lib/GroupDataModel';
        ...
        <>
            <GlobalContext.Consumer>
                {({ myProfile }) => <>
                    ...
                    {groups.map((g, index) => {
                        return (
                            <Box sx={{ maxWidth: 'fit-content', alignItems: 'flex-start'}}>
                                <MyGroupGalleryCard key={index} group={g} />
                            </Box>
                        );
                    })}
                    </Stack>
